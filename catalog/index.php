...
$APPLICATION->SetPageProperty("title", "Каталог каминов - цены, фото дровяных печей-каминов в интерьере");
$APPLICATION->SetPageProperty("description", "Электронный каталог дровяных каминов, печей и топок. Классические, современные, хай-тек камины в интерьере гостиной");

$cn=24;
if((int)$_GET["size"]==12 || (int)$_GET["size"]==48 || (int)$_GET["size"]==72) $cn=(int)$_GET["size"];

$OPTIMUS_SMART_FILTER=array();
$OPTIMUS_SMART_FILTER[]=array("LOGIC"=>"OR",array("PROPERTY_REGIONS"=>false),array("!PROPERTY_REGIONS"=>false,"PROPERTY_REGIONS"=>$_SESSION['CURRENT_LOCATION']['CURRENT']["ID"]));
...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PRICE_CODE" => array(
			0 => $_SESSION['CURRENT_LOCATION']['CURRENT']["PRICES"]["PRICE"]
		),
		"USE_PRICE_COUNT" => "N",
		"SHOW_PRICE_COUNT" => "1",
		"PRICE_VAT_INCLUDE" => "Y",
		...
		"PAGE_ELEMENT_COUNT" => $cn,
		"LINE_ELEMENT_COUNT" => "4",
		//"ELEMENT_SORT_FIELD" => "price",
		"ELEMENT_SORT_FIELD" => "sort",
		"ELEMENT_SORT_ORDER" => "asc",
		"ELEMENT_SORT_FIELD2" => "PROPERTY_DISCONTINUED",
		...
		"SORT_PRICES" => "MINIMUM_PRICE_".$_SESSION['CURRENT_LOCATION']['CURRENT']["PRICES"]["PRICE_ID"],
		...
		"OFFERS_SORT_FIELD" => "CATALOG_PRICE_".$_SESSION["CURRENT_LOCATION"]["CURRENT"]["PRICES"]["PRICE_ID"],
