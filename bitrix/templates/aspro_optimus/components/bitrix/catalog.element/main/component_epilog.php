...
<?
$discounts="";
$db_res = CSaleDiscount::GetList(array("SORT" => "ASC"),array("LID" => SITE_ID,"ACTIVE" => "Y",),false,false,array('LID','NAME',"XML_ID","ACTIVE","SORT","CONDITIONS","UNPACK","APPLICATION","ACTIONS","USE_COUPONS","USER_GROUPS"));
while ($ar_res = $db_res->Fetch())
{
   $discounts.=implode(",", $ar_res);
}
			...
			<?foreach($arResult['OFFERS'] as $arOffer):?>
				<?if(!$arOffer['OFFER_GROUP']) continue;?>
					<?$APPLICATION->IncludeComponent("bitrix:catalog.set.constructor", "",
						array(
							"CACHE_DISCOUNTS" => $discounts,
							"SPAN_ID" => $arItemIDs['ALL_ITEM_IDS']['OFFER_GROUP'].$arOffer['ID'],
