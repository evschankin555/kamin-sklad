...
$arrFilter = array();
$arrFilter[]=array("LOGIC"=>"OR",array("PROPERTY_REGIONS"=>false),array("!PROPERTY_REGIONS"=>false,"PROPERTY_REGIONS"=>$_SESSION['CURRENT_LOCATION']['CURRENT']["ID"]));

if ((int)$arParams["NEWS_ID"]>0) $arrFilter[]=array("PROPERTY_NEWS"=>$arParams["NEWS_ID"]);
if ((int)$arParams["ARTICLES_ID"]>0) $arrFilter[]=array("PROPERTY_ARTICLES"=>$arParams["ARTICLES_ID"]);
if ((int)$arParams["CATALOG_ID"]>0) $arrFilter[]=array("PROPERTY_CATALOG"=>$arParams["CATALOG_ID"]);
