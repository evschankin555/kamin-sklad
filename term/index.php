...
$APPLICATION->SetPageProperty("title", "Из чего состоит камин. Словарь каминных терминов");
$APPLICATION->SetPageProperty("description", "Конструктивные элементы: виды и типы каминов, чем отличаются печь от камина");
$APPLICATION->SetTitle("Термины");
?><?$APPLICATION->IncludeComponent("bitrix:news.list", "term", Array(
