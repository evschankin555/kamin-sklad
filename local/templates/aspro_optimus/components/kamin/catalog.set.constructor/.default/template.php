	...
	<div class="row">
				...
				<table class="bx-added-item-table">
					...
					<?foreach($arResult["SET_ITEMS"]["DEFAULT"] as $key => $arItem):?>
						<tr
							...
							data-print-price="<?=str_replace("\"","'",$arItem["PRICE_PRINT_DISCOUNT_VALUE"])?>"
							data-old-price="<?=$arItem["PRICE_VALUE"]?>"
							data-print-old-price="<?=str_replace("\"","'",$arItem["PRICE_PRINT_VALUE"])?>"
		...
		<div class="col-sm-3">
			<div class="bx-constructor-container-result">
				...
				?></span>
				<div>
					<br><a href="javascript:void(0)" data-role="set-buy-btn" class="btnr"><?=GetMessage("CATALOG_SET_BUY")?></a>
				</div>
			</div>
		</div>
	</div>
				...
				>
					<div class="bx-catalog-set-item">
						...
						<div class="bx-catalog-set-item-add-btn">
							...
							if ($arItem['CAN_BUY'])
							{
								?><a href="javascript:void(0)" data-role="set-add-btn" class="btnr"><?= GetMessage("CATALOG_SET_BUTTON_ADD") ?></a><?
							}
							else
							{
