...
$db_props = CIBlockElement::GetProperty($arResult["ELEMENT"]["IBLOCK_ID"], $arResult["ELEMENT"]["ID"], array("sort" => "asc"), Array("CODE"=>"NAIMENOVANIE_DLYA_WEB_FS_GB_"));
if($ar_props = $db_props->Fetch())
{
	$arResult["ELEMENT"]["NAME"]=$ar_props["VALUE_ENUM"]." ".$arResult["ELEMENT"]["NAME"];
}
	...
	{       
        ...
        'BASKET_ITEMS' => array(
           array(
              ...
              'PRODUCT_PRICE_ID' => 0, 
              'PRICE' => $arResult["ELEMENT"]["PRICE_VALUE"], 
           ...
           array(
              ...
              'PRODUCT_PRICE_ID' => 0, 
              'PRICE' => $arItem["PRICE_VALUE"], 
              'BASE_PRICE' => $arItem["PRICE_VALUE"], 
