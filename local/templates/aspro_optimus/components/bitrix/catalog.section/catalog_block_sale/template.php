...
<?if(!$arItem["ISHIDEDISCOUNT"]){?>                                                
											<div class="price__old" id="<? echo $arItemIDs["ALL_ITEM_IDS"]['PRICE_OLD']; ?>">
...
<?}else{?>
	...
	<div class="no_goods catalog_block_view">
		...
		<?if($_REQUEST["set_filter"]){?>
			<span class="button wide" onclick="location.href='?';"><?=GetMessage('RESET_FILTERS');?></span>
		<?}?>
	</div>
<?}?>
