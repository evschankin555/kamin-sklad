...
<?if( !empty($arResult["DISPLAY_PROPERTIES"]["BIG_PHOTO"]["FILE_VALUE"])):?>
<div class="big__foto"><img src="<?=$arResult["DISPLAY_PROPERTIES"]["BIG_PHOTO"]["FILE_VALUE"]["SRC"]?>" alt="<?=($arResult["DETAIL_PICTURE"]["ALT"] ? $arResult["DETAIL_PICTURE"]["ALT"] : $arResult["NAME"])?>" title="<?=($arResult["DETAIL_PICTURE"]["TITLE"] ? $arResult["DETAIL_PICTURE"]["TITLE"] : $arResult["NAME"])?>"/></div>
<?endif;?>
	...
	<?if (strlen($arResult["DISPLAY_PROPERTIES"]["VIDEO"]["DISPLAY_VALUE"])>0):?>
	    <iframe allowfullscreen="" frameborder="0" width="917" height="516" src="//www.youtube.com/embed/<?=$arResult["DISPLAY_PROPERTIES"]["VIDEO"]["DISPLAY_VALUE"]?>" ></iframe><br>
	<?endif;?>    
