...
<?
if($active_year){
    $GLOBALS['arrFilter'][">=DATE_ACTIVE_FROM"] = ConvertDateTime("01.01.".$active_year, "DD.MM.YYYY");
    $GLOBALS['arrFilter']["<DATE_ACTIVE_FROM"] = ConvertDateTime("01.01.".($active_year+1), "DD.MM.YYYY");
}
$GLOBALS['arrFilter'][]=array("LOGIC"=>"OR",array("PROPERTY_REGIONS"=>false),array("!PROPERTY_REGIONS"=>false,"PROPERTY_REGIONS"=>$_SESSION['CURRENT_LOCATION']['CURRENT']["ID"]));
?>
<?$APPLICATION->IncludeComponent(
	"bitrix:news.list",
	"main_template",
...
<?if ($arParams["SHOW_FAQ_BLOCK"]=="Y" && false):?></div><?endif;?>